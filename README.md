...
## Projektüberblick
Gebäude sind für einen erheblichen Teil des weltweiten Energieverbrauchs verantwortlich, insbesondere durch Heizungs-, Lüftungs- und Klimaanlagen (HVAC). Dieses Projekt implementiert eine prädiktive **Machine Learning Pipeline** zur Erkennung der Raumbelegung basierend auf **IoT-Sensordaten**. 

**Das Ziel:** Durch die präzise Vorhersage, ob ein Raum belegt ist, können Gebäudemanagementsysteme den Energieverbrauch dynamisch anpassen. Dies ermöglicht eine erhebliche Kostensenkung, während der Nutzerkomfort gewahrt bleibt.
